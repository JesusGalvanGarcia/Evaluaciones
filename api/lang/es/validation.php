...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "commission_active" => "Comisión de Intereses",
        "cut_day" => "Día de Corte",
        "cp" => "Código Postal",
        "day" => "Día",
        "email" => "Correo Electrónico",
        "initial_commission" => "Comisión por Ingreso",
        "interest" => "Intereses",
        "investment_end" => "Fin de Préstamo",
        "investment_start" => "Inicio de Préstamo",
        "lastname_father" => "Apellido Paterno",
        "lastname_mother" => "Apellido Materno",
        "max_investment" => "Monto Máximo",
        "min_investment" => "Monto Mínimo",
        "month" => "Mes",
        "name" => "Nombre",
        ...
        "percent" => "porcentaje",
        "phone" => "Teléfono",
        "renewal_commission" => "Comisión por Renovación",
        "type_id" => "Tipo",
        "user_id" => "Id Usuario",
        "year" => "Año",
        "scatter_key" => "Clave de Dispersión",
        "suburb" => "Colonia",
        "township" => "Municipio",
        "state" => "Estado",
        "account_holder" => "Cuentahabiente",
        "bank_id" => "Banco (id)",
        "bank" => "Banco",
        "account_number" => "Número de Cuenta",
        "investors" => "Acreedores",
        "bank_account_id" => "Cuenta bancaria",
        "investor_id" => "Acreedor",
        "contract_type_id" => "Tipo de Contrato",
        "interest_type_id" => "Tipo de Interés",
        "start_date" => "Fecha de Inicio",
        "frequency_id" => "Frecuencia",
        "payment_method_id" => "Método de Pago",
        "responsable_id" => "Responsable",
        "account" => "Cuenta",
        "projected_rate_id" => "Id Tasa Proyectada",
