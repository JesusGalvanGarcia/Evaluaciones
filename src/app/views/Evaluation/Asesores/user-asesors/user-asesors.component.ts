...
export class UserAsesorsComponent implements OnInit {
  ...
  constructor(public asesores: AsesoresService,private fb: FormBuilder,public message:MensajeService,public evaluation360:Evaluation360Service, public router:Router,   private route: ActivatedRoute) {
  ...
  send()
  {
    ...
    this.asesores.AssingAsesors(data)  //Cargar examen
    .then((response: any) => {
